...
{
      14,     0,    -1,    17,    12,    15,    -1,    15,    16,    -1,
      -1,    10,    19,    -1,     9,    19,     7,    19,    -1,    11,
      19,     7,    19,    -1,    17,    18,    -1,    -1,    19,     5,
      19,     6,    -1,     3,    19,     5,    19,     6,    -1,    19,
       5,     3,    19,     6,    -1,    19,     5,     4,    19,     6,
      -1,     8,    -1
};
...
{
  "$end", "error", "$undefined", "STAR_TOK", "AND_TOK", "EQ",
  "SEMI_COLON", "COMMA", "IDENTIFIER", "POINTSTO_TOK", "PRINTSET_TOK",
  "DEREFERENCEABLE_TOK", "SEPARATOR", "$accept", "program", "queries",
  "query", "statements", "statement", "identifier", 0
};
#endif
...
{
       9,     0,     0,     1,     0,    14,     4,     8,     0,     0,
       2,     0,     0,     0,     0,     0,     3,     0,     0,     0,
       0,     0,     5,     0,     0,     0,    10,    11,     0,     0,
      12,    13,     6,     7
};
...
{
      -7,    15,     9,    -7,     8,    -7,    -7,    -7,    13,    14,
      -6,    -2,     8,     8,     8,     8,    -7,     8,     8,    16,
      17,    19,    -7,    20,    22,    23,    -7,    -7,     8,     8,
      -7,    -7,    -7,    -7
};
...
{
       9,    17,    18,    13,    14,    15,     5,    19,    20,    21,
      22,    23,     4,    24,    25,     3,     5,     5,    11,    12,
       0,     6,    26,    27,    32,    33,    28,    29,    30,    31
};

static const yytype_int8 yycheck[] =
{
       4,     3,     4,     9,    10,    11,     8,    11,    12,    13,
      14,    15,     3,    17,    18,     0,     8,     8,     5,     5,
      -1,    12,     6,     6,    28,    29,     7,     7,     6,     6
};
...
{
       0,    14,    17,     0,     3,     8,    12,    18,    19,    19,
      15,     5,     5,     9,    10,    11,    16,     3,     4,    19,
      19,    19,    19,    19,    19,    19,     6,     6,     7,     7,
       6,     6,    19,    19
};
...
#line 101 "l13.y"
    {
		...
		item = searchSymbol((yyvsp[(3) - (4)].id)->value, symbolTable);
		if (item == NULL)
			error("Identifier not found");
...
#line 115 "l13.y"
    {
		...
		if (item == NULL)
			error("Identifier not found");
		ass->lValue = item->data;
		item = searchSymbol((yyvsp[(4) - (5)].id)->value, symbolTable);
		if (item == NULL)
			error("Identifier not found");
		ass->rValue = item->data;
		(yyval.ass) = ass;
